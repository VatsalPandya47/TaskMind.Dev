      ...
      <section className="py-16 bg-white">
        <div className="container mx-auto px-4">
          <div className="max-w-6xl mx-auto">
            <h2 className="text-3xl font-bold text-black mb-12 text-center">Our Privacy Principles</h2>
            <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-8 mb-16">
              {principles.map((principle, index) => (
                <div key={index} className="text-center">
                  <div className="bg-blue-100 w-16 h-16 rounded-2xl flex items-center justify-center mx-auto mb-6">
                    <principle.icon size={32} className="text-blue-600" />
                  </div>
                  <h3 className="text-xl font-semibold text-black mb-4">{principle.title}</h3>
          ...
          <div className="max-w-4xl mx-auto">
            <div className="bg-white rounded-2xl p-8 md:p-12 shadow-lg">
              <div className="prose prose-lg max-w-none">
                ...
                <h3 className="text-xl font-semibold text-black mb-4">Meeting Data</h3>
                <p className="text-gray-600 mb-6">
                ...
                <h3 className="text-xl font-semibold text-black mb-4">Usage Information</h3>
                ...
                <h2 className="text-2xl font-bold text-black mb-6">3. Data Security</h2>
                <p className="text-gray-600 mb-6">
                ...
                <h2 className="text-2xl font-bold text-black mb-6">4. Data Sharing</h2>
                <p className="text-gray-600 mb-6">
                ...
                <h2 className="text-2xl font-bold text-black mb-6">5. Your Rights</h2>
                <p className="text-gray-600 mb-6">
                ...
                <h2 className="text-2xl font-bold text-black mb-6">6. Data Retention</h2>
                <p className="text-gray-600 mb-8">
                ...
                <h2 className="text-2xl font-bold text-black mb-6">7. International Transfers</h2>
                <p className="text-gray-600 mb-8">
                ...
                <h2 className="text-2xl font-bold text-black mb-6">8. Contact Us</h2>
