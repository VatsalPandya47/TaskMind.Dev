-- Manual Trello Database Table Fix
-- Copy and paste this into Supabase Dashboard > SQL Editor if the automated fix doesn't work
...
SELECT 'Trello tokens table created successfully!' as status; 