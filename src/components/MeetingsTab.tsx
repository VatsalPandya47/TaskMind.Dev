...
const MeetingsTab = () => {
  ...
  return (
    <ThemeGradientWrapper>
      <div className="flex justify-between items-center">
        <div>
          <h1 className="heading-gradient">Meetings</h1>
          <p className="text-default">Turn every conversation into actionable insights</p>
        </div>
        <Button onClick={() => setIsDialogOpen(true)} className="bg-blue-600 hover:bg-blue-700 text-white rounded-xl px-6 py-2.5 font-medium transition-all duration-200 hover:scale-105 shadow-lg hover:shadow-xl">
          New Meeting
        </Button>
      </div>
      ...
      <Card className="card-surface">
        <CardHeader>
          <div className="flex items-center justify-between">
            <div>
              <CardTitle className="text-xl font-semibold text-white">Meeting Intelligence</CardTitle>
      ...
      <Card className="bg-blue-500/10 backdrop-blur-sm border-blue-500/20 shadow-lg hover:border-blue-800/30 transition-all duration-200">
        <CardHeader>
        ...
        <CardContent>
          <div className="grid grid-cols-1 md:grid-cols-4 gap-4">
            <div className="text-center">
              <div className="text-2xl font-bold text-blue-500">{totalMeetings}</div>
              <div className="text-sm text-default">Total Meetings</div>
            </div>
            <div className="text-center">
              <div className="text-2xl font-bold text-indigo-500">{meetingsWithRecordings}</div>
              <div className="text-sm text-default">With Recordings</div>
            </div>
            <div className="text-center">
              <div className="text-2xl font-bold text-purple-500">{meetingsThisMonth}</div>
              <div className="text-sm text-default">This Month</div>
            </div>
            <div className="text-center">
              <div className="text-2xl font-bold text-green-700 dark:text-green-500">GPT-4o</div>
              <div className="text-sm text-default">AI Model</div>
            </div>
          </div>
        </CardContent>
      </Card>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
        <Card className="card-surface hover-elevate">
        ...
        <Card className="card-surface hover-elevate">
          <CardContent className="p-6">
            <div className="flex items-center justify-between">
              <div>
                <p className="text-sm font-medium text-gray-300">Recorded</p>
                <p className="text-2xl font-semibold text-white">{meetingsWithRecordings}</p>
              </div>
          ...
          <CardContent className="p-6">
            <div className="flex items-center justify-between">
              <div>
                ...
                <p className="text-2xl font-semibold text-white">{meetingsThisMonth}</p>
              </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
            ...
            {(filters.search || filters.hasRecording) && (
              <Button 
                ...
                size="sm"
                className="button-gradient-blue-purple rounded-2xl"
              >
                Clear Filters
              </Button>
            )}
              ...
              {filteredMeetings.length === 0 ? (
                ...
                <div className="space-y-4">
                  {filteredMeetings.map((meeting) => (
                    <div key={meeting.id} className="flex items-center justify-between p-4 bg-gray-700/50 rounded-2xl pop-up-hover border border-gray-600/30">
