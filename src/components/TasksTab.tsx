      ...
      <div className="min-h-screen bg-gradient-to-br from-gray-900 via-blue-900 to-gray-900 relative overflow-hidden">
        ...
        <div className="relative z-10 container mx-auto px-6 py-20 space-y-6">
          <div className="flex justify-between items-center">
            <div>
              <h1 className="text-4xl font-bold bg-gradient-to-r from-white via-blue-200 to-indigo-200 bg-clip-text text-transparent">Tasks</h1>
              <p className="text-gray-300">Focus on what matters most</p>
            </div>
          </div>
      ...
      <div className="relative z-10 container mx-auto px-6 py-20 space-y-6">
        ...
        {showCreateForm && (
          <Card className="bg-blue-500/10 backdrop-blur-sm border-blue-500/20 shadow-lg">
            <CardHeader>
              <div className="flex justify-between items-center">
                <CardTitle className="text-blue-400">Create New Mission 🚀</CardTitle>
                <Button 
                  variant="ghost" 
                  size="sm"
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                  <div className="space-y-2">
                    ...
                    <Input
                      ...
                      className="bg-gray-800/60 border-gray-700/50 text-white placeholder-gray-400 focus:border-blue-400"
                      required
                    />
                  </div>
                  <div className="space-y-2">
                  ...
                  <div className="space-y-2">
                    ...
                    <Input
                      ...
                      className="bg-gray-800/60 border-gray-700/50 text-white focus:border-blue-400"
                    />
                  </div>
                  <div className="space-y-2">
                          ...
                          {editingTask === task.id ? (
                            <div className="flex items-center gap-2">
                              ...
                              <div className="flex flex-col gap-1">
                                ...
                                <Button
                                  ...
                                  className="border-gray-600 text-gray-300 hover:bg-gray-700/50 px-2 py-1 h-auto"
                                >
                                  <X className="h-3 w-3" />
                                </Button>
                              </div>
                            ...
                            <div className="flex items-start gap-2">
                              ...
                              <Button
                                ...
                                className="text-gray-400 hover:text-blue-400 px-2 py-1 h-auto"
                              >
