        ...
        <div className="flex flex-col lg:flex-row lg:items-center lg:justify-between gap-4">
          <div>
            <h1 className="text-3xl font-bold mb-2 flex items-center gap-2">
              ...
              <span className="heading-gradient">Calendar</span>
            </h1>
            <p className="text-default">View and manage all your synchronized meetings</p>
          </div>
          
          <div className="flex items-center gap-3">
            <Select value={filterType} onValueChange={(value: any) => setFilterType(value)}>
              <SelectTrigger className="w-40 selector-button">
                <SelectValue />
              </SelectTrigger>
              <SelectContent className="bg-default border-gray-700">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
          ...
          <Card className="bg-gray-800/60 backdrop-blur-sm border-gray-700/50">
            <CardContent className="p-6">
              <div className="flex items-center justify-between">
                <div>
                  <p className="text-sm text-gray-300">Zoom Meetings</p>
                      ...
                      <div className="flex items-start gap-3">
                        ...
                        <div className="flex-1 min-w-0">
                          ...
                          <div className="flex items-center gap-2 mt-2">
                            <Badge variant="outline" className="text-xs border-current text-white">
                              {event.type}
                            </Badge>
                            {event.hasRecording && (
          ...
          <CardContent>
            ...
            {filteredEvents.filter(event => new Date(event.date) >= new Date()).length === 0 && (
              <div className="text-center py-8">
                ...
                <p className="text-gray-300 mb-3">No upcoming meetings</p>
                <Button 
                  variant="outline" 
                  size="sm" 
                  className="button-solid-primary"
