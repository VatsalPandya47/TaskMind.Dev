    ...
    return (
      <div className="container mx-auto px-4 py-8">
        <div className="flex justify-between items-center mb-8">
          <div>
            <h1 className="text-3xl font-bold">My Summary History</h1>
            <p className="text-muted-foreground">View all your AI-generated meeting summaries</p>
          </div>
        </div>
      ...
      {summaries.length === 0 ? (
        ...
        <div className="space-y-6">
          {summaries.map((summary) => {
            ...
            return (
              <Card key={summary.id} className="border-2 border-gray-100 hover:border-gray-200 transition-colors">
                <CardHeader>
                ...
                <CardContent className="space-y-4">
                  ...
                  <details className="group">
                    <summary className="flex items-center gap-2 text-blue-600 cursor-pointer hover:text-blue-800 font-medium">
